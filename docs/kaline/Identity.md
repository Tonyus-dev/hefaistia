# Identity.md — ponteiro

A identidade canônica da Kaline V23 vive em **`docs/canon/Identity.md`** (fonte única).
Este arquivo deixou de ser espelho para evitar duplicação e divergência manual.
